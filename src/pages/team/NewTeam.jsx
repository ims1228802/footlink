            ...
            <main>
                ...
                <div className="flex-div">
                    <div>
                        ...
                        <div className="emblem-div">
                            ...
                            <div className="button-div">
                                <button type="button" onClick={() => openModel('upload')}>엠블렘 사진 업로드</button>
                                <button type="button" onClick={() => openModel('emblemMake')}>엠블렘 만들기</button>
                            </div>
                        </div>
                    </div>
                    <div className="input-div">
                        ...
                        <p>팀 코드</p>
                        <input type="text" placeholder="팀 코드를 입력해주세요"/>
                    </div>
                </div>
                <div className="date-div">
                    ...
                    <section className="checkbox-section">
                        ...
                        <label htmlFor="late-night" className="checkbox-layout-l">
                            <p>심야</p>
                            <p>24시 ~ 06시</p>
                        </label>
                    </section>
